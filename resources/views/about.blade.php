                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <div class="header-left d-flex align-items-center">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img width="200px" height="100px" src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt=""></a>
                            </div>
                            <!-- Main-menu -->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <div class="about-img pb-bottom">
                            <img src="{{ asset('frontend/assets/img/gallery/about1.png') }}" alt="" class="w-100">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <div class="about-img pb-bottom">
                            <img src="{{ asset('frontend/assets/img/gallery/about2.png') }}" alt="" class="w-100">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="{{ asset('fromtend/assets/img/gallery/popular4.png') }}" alt="">
                                <div class="img-cap">
                                    <span>Clothes</span>
                                </div>
                                <div class="favorit-items">
