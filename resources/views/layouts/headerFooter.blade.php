...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/css/custombotstrap.css')}}">
                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="header-right1 d-flex align-items-center">
                            <a class="logregbtn" href="#" role="button">LOGIN</a>
                            &nbsp;
                            <a class="logregbtn" href="#" role="button">REGISTER</a>
                            &nbsp;
                            <!-- Social -->
